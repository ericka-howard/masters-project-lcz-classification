...
ggsave(here("results/plots", "varied_ntree_f1_not_done.tiff"))
```
...
ggplot(dat)+
  geom_boxplot(aes(x=Class, y=F1))

ggsave(here("results/plots", "varied_ntree_f1_alternative_not_done.tiff"))
```
