...
```{r maps1, echo = FALSE, message=FALSE, fig.show='hold',fig.align='center', out.width="45%", fig.pos='H'}
knitr::include_graphics(c("../results/map_images/google_satellite.pdf","../results/map_images/one_landsat_scene.pdf"))
```

```{r maps2, echo = FALSE, message=FALSE,fig.align='center', out.width="60%", fig.pos='H'}
