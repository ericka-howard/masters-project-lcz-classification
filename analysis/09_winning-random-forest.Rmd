...
f1_just_plot <- f1_plot + theme(legend.position = "none", strip.text = element_blank())

facet_pair <- plot_grid(oa_just_plot, legend, f1_just_plot, placeholder_plot, nrow=2, rel_widths = c(1, 0.2), rel_heights = c(1.7, 3.1))
